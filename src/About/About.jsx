...
function About() {
  return (
    ...
    data-aos-easing="linear" className="text-white pl-[10px] pt-[10px] text-[35px] font-[700] font-sans md:pt-[30px] lg:text-[40px] xl:p-[10px] ">
        <span className="text-[#ff4c00]">A</span>bout
      </h1>
      <div 
            
             className=" pl-5 pt-[10px] flex justify-around items-center gap-[30px]  lg:flex-row lg:justify-around">
       
        <div data-aos="zoom-in-up"
    data-aos-duration="600"
    data-aos-easing="linear" className="w-[35%] h-[180px] md:w-[40%] md:h-[350px] lg:w-[25%] xl:h-[450px]">
