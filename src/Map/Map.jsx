  ...
  return (
    <div className="p-[5px]  bg-black  w-full lg:flex md:pb-[50px]">
      ...
      <div className="w-full h-[350px] flex flex-col items-start justify-around pl-[20px] md:flex-row md:items-center md:justify-around md:pl-[0] md:w-[100%] lg:flex-col lg:gap-2">
        <div className="h-[116px] flex items-center justify-center gap-[20px] pt-[30px] md:p-[5px] md:bg-[#ff00001b] md:pt-[0] md:h-[115px] md:w-[32%] md:shadow-[#ff8787a6] md:shadow-lg lg:bg-transparent lg:w-[70%] lg:h-[100px]">
        ...
        <div className=" h-[116px] flex items-center justify-center gap-[10px] pt-[30px] md:p-[5px] md:bg-[#ff00001b] md:pt-[0] md:h-[115px] md:w-[32%] md:shadow-[#ff8787a6] md:shadow-lg lg:bg-transparent lg:w-[70%] lg:h-[100px]">
